...
class Aplicacao(TK, front_Ferramentas, Reserva):
    ...
    def botoes(self):
        self.bt_cadastrar_tec = tk.Button(self.frame_tecnico, text="Acessar", command=self.janela_frontT, bd=3,
                                          font=('poppins', 19, 'bold'))
        self.bt_cadastrar_tec.place(relx=0.1, rely=0.8, relwidth=0.8, relheight=0.15)

        self.bt_cadastrar_ferramenta = tk.Button(self.frame_ferramenta, text="Acessar", bd=3,
                                                 font=('poppins', 19, 'bold'), command=self.janela_frontF)
        self.bt_cadastrar_ferramenta.place(relx=0.1, rely=0.8, relwidth=0.8, relheight=0.15)

        self.bt_cadastrar_reserva = tk.Button(self.frame_reserva, text="Acessar", bd=3, font=('poppins', 19, 'bold'),
                                              command=self.janela_cadastro_reservas)
        self.bt_cadastrar_reserva.place(relx=0.1, rely=0.8, relwidth=0.8, relheight=0.15)

    def labels(self):
        self.label_titulo = tk.Label(self.frame_titulo, text="Central de Ferramentaria", bg='#B9B7BD',
        ...
        self.label_copyright = tk.Label(self.frame_copyright,
                                        text="copyright © 2022 - Todos os direitos reservados - DevTeam13",
                                        bg='#B9B7BD',
